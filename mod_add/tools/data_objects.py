...
class seed_average_onerun:
    ...
    def linear_decomposition_plot(self, non_grokked_object):
        titles = [
            ...
            r"$\text{(c) Grokking loss in training}$",
            r"$\text{(d) Learning loss in training}$",
            r"$\text{(e) Grok linear and non-linear loss - test}$",
            r"$\text{Learn linear and non-linear loss - test}$",
            r"$\text{Grok linear and non-linear norms - test}$",
            r"$\text{Learn linear and non-linear norms - test}$",
            r"$\text{(e) Grok linear and non-linear loss - train}$",
            r"$\text{Learn linear and non-linear loss - train}$",
            r"$\text{Grok linear and non-linear norms - train}$",
            r"$\text{Learn linear and non-linear norms - train}$",
        ]
        ...
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(len(self.linear_decomposition["linear_loss_test"]))
                ),
                y=self.linear_decomposition["linear_loss_test"],
                mode="lines",
                line=dict(color="red", dash="dash"),
                showlegend=True,
                name=r"$\text{Grok linear loss test}$",
            ),
            row=2,
            col=1,
        )
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(
                        len(self.linear_decomposition["non_linear_loss_test"])
                    )
                ),
                y=self.linear_decomposition["non_linear_loss_test"],
                mode="lines",
                line=dict(color="red", dash="dot"),
                showlegend=True,
                name=r"$\text{Grok non-linear loss test}$",
            ),
            row=2,
            col=1,
        )
        fig.add_trace(
            go.Scatter(
                x=list(range(len(self.linear_decomposition["full_loss_test"]))),
                y=self.linear_decomposition["full_loss_test"],
                mode="lines",
                line=dict(color="red", dash="solid"),
                showlegend=True,
                name=r"$\text{Grok full loss test}$",
            ),
            row=2,
            col=1,
        )
        ...
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(
                        len(
                            non_grokked_object.linear_decomposition[
                                "linear_loss_test"
                            ]
                        )
                    )
                ),
                y=non_grokked_object.linear_decomposition["linear_loss_test"],
                mode="lines",
                line=dict(color="blue", dash="dash"),
                showlegend=True,
                name=r"$\text{Learn linear loss test}$",
            ),
            row=2,
            col=2,
        )
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition[
                    "non_linear_loss_test"
                ],
                mode="lines",
                line=dict(color="blue", dash="dot"),
                showlegend=True,
                name=r"$\text{Learn non-linear loss test}$",
            ),
            row=2,
            col=2,
        )
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition["full_loss_test"],
                mode="lines",
                line=dict(color="blue", dash="solid"),
                showlegend=True,
                name=r"$\text{Learn full loss test}$",
            ),
            row=2,
            col=2,
        )
        ...
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(len(self.linear_decomposition["linear_norm_test"]))
                ),
                y=self.linear_decomposition["linear_norm_test"],
                mode="lines",
                line=dict(color="red", dash="dash"),
                showlegend=True,
                name=r"$\text{Grok linear norm test}$",
            ),
            row=2,
            col=3,
        )
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(
                        len(self.linear_decomposition["non_linear_norm_test"])
                    )
                ),
                y=self.linear_decomposition["non_linear_norm_test"],
                mode="lines",
                line=dict(color="red", dash="dot"),
                showlegend=True,
                name=r"$\text{Grok non-linear norm test}$",
            ),
            row=2,
            col=3,
        )
        fig.add_trace(
            go.Scatter(
                x=list(range(len(self.linear_decomposition["diff_norm_test"]))),
                y=self.linear_decomposition["diff_norm_test"],
                mode="lines",
                line=dict(color="red", dash="solid"),
                showlegend=True,
                name=r"$\text{Grok diff norm test}$",
            ),
            row=2,
            col=3,
        )
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition["linear_norm_test"],
                mode="lines",
                line=dict(color="blue", dash="dash"),
                showlegend=True,
                name=r"$\text{Learn linear norm test }$",
            ),
            row=2,
            col=4,
        )
        fig.add_trace(
            go.Scatter(
                ...
                line=dict(color="blue", dash="dot"),
                showlegend=True,
                name=r"$\text{Learn non-linear norm test}$",
            ),
            row=2,
            col=4,
        )
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition["diff_norm_test"],
                mode="lines",
                line=dict(color="blue", dash="solid"),
                showlegend=True,
                name=r"$\text{Learn diff norm test}$",
            ),
            row=2,
            col=4,
        )
        ...
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(len(self.linear_decomposition["linear_loss_train"]))
                ),
                y=self.linear_decomposition["linear_loss_train"],
                mode="lines",
                line=dict(color="red", dash="dash"),
                showlegend=False,
                name=r"$\text{Grok linear loss train}$",
            ),
            row=3,
            col=1,
        )
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(
                        len(self.linear_decomposition["non_linear_loss_train"])
                    )
                ),
                y=self.linear_decomposition["non_linear_loss_train"],
                mode="lines",
                line=dict(color="red", dash="dot"),
                showlegend=False,
                name=r"$\text{Grok non-linear loss train}$",
            ),
            row=3,
            col=1,
        )
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(len(self.linear_decomposition["full_loss_train"]))
                ),
                y=self.linear_decomposition["full_loss_train"],
                mode="lines",
                line=dict(color="red", dash="solid"),
                showlegend=False,
                name=r"$\text{Grok full loss train}$",
            ),
            row=3,
            col=1,
        )
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition["linear_loss_train"],
                mode="lines",
                line=dict(color="blue", dash="dash"),
                showlegend=False,
                name=r"$\text{Learn linear loss train}$",
            ),
            row=3,
            col=2,
        )
        fig.add_trace(
            go.Scatter(
                ...
                line=dict(color="blue", dash="dot"),
                showlegend=False,
                name=r"$\text{Learn non-linear loss train}$",
            ),
            row=3,
            col=2,
        )
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition["full_loss_train"],
                mode="lines",
                line=dict(color="blue", dash="solid"),
                showlegend=False,
                name=r"$\text{Learn full loss train}$",
            ),
            row=3,
            col=2,
        )
        ...
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(len(self.linear_decomposition["linear_norm_train"]))
                ),
                y=self.linear_decomposition["linear_norm_train"],
                mode="lines",
                line=dict(color="red", dash="dash"),
                showlegend=False,
                name=r"$\text{Grok linear norm train}$",
            ),
            row=3,
            col=3,
        )
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(
                        len(self.linear_decomposition["non_linear_norm_train"])
                    )
                ),
                y=self.linear_decomposition["non_linear_norm_train"],
                mode="lines",
                line=dict(color="red", dash="dot"),
                showlegend=False,
                name=r"$\text{Grok non-linear norm train}$",
            ),
            row=3,
            col=3,
        )
        fig.add_trace(
            go.Scatter(
                x=list(
                    range(len(self.linear_decomposition["diff_norm_train"]))
                ),
                y=self.linear_decomposition["diff_norm_train"],
                mode="lines",
                line=dict(color="red", dash="solid"),
                showlegend=False,
                name=r"$\text{Grok diff norm train}$",
            ),
            row=3,
            col=3,
        )
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition["linear_norm_train"],
                mode="lines",
                line=dict(color="blue", dash="dash"),
                showlegend=False,
                name=r"$\text{Learn linear norm train}$",
            ),
            row=3,
            col=4,
        )
        fig.add_trace(
            go.Scatter(
                ...
                line=dict(color="blue", dash="dot"),
                showlegend=False,
                name=r"$\text{Learn non-linear norm train}$",
            ),
            row=3,
            col=4,
        )
        fig.add_trace(
            go.Scatter(
                ...
                y=non_grokked_object.linear_decomposition["diff_norm_train"],
                mode="lines",
                line=dict(color="blue", dash="solid"),
                showlegend=False,
                name=r"$\text{Learn diff norm train}$",
            ),
            row=3,
            col=4,
        )
