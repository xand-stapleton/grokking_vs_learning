...
class AnalysableModel:
    def __init__(self):
        ...
        # Instantiate the original network so we have a reference when pruned
    ...
    def evaluate_analysis_quantities(
        ...
        # Iterate through the hyperparameters and check if
        ...
        for quantity, boolean in evaluate_dic.items():
            if quantity == "euclidcosine" and boolean:
                ...
                if (
                    cos_sim_model is not None and cos_sim_steps is not None
                    ...
                    # I may rue this later, but technically
                    # it's correct to leave blank for epochs
                    # we haven't calculated anything for.
                    self.analysable_quantites["euclidcosine"].append(
            ...
            if quantity == "fims" and boolean:
                ...
                if epoch % 100 == 0 or (epoch < 2000 and epoch % 5 == 0):
                    Path(self.fim_dir).mkdir(parents=True, exist_ok=True)
